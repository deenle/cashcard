...
public class CashCardJsonTest {
    ...
    void cashCardSerializationTest() throws IOException {
        ...
        Assertions.assertThat(json.write(cashCard)).isStrictlyEqualToJson("single.json");
    ...
    void cashCardDeserializationTest() throws IOException {
        String expected = """
                ...
                """;
        Assertions.assertThat(json.parse(expected)).isEqualTo(new CashCard(99L, 123.45, "sarah1"));
